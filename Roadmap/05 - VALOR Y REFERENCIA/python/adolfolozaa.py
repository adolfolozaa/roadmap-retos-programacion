...
my_int_a = 30
print(my_int_a)
print(my_int_b) # se queda con el valor que tenia cuando lo adquirio

# Tipos de dato por referencia. Los datos por referencia no copian su valor sino heredan su posicion de memoria
...
# por referencia: funciona igual que el anterior porque estamos almacenando el dato del puntero
def ref(value_a: list, value_b: list) -> tuple:
    temp = value_a
    value_a = value_b
    value_b = temp
    #value_c = value_a
    #value_c.append(50) Si modificamos value_a se modifica value_a
    return value_a, value_b
